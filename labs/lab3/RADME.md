...
###  Решение:
Графическая схема до начал работы, с нанесенной информацией о ионетфейсах и настраиваемых VLAN
![](DHCPv4_start.png)
...
1.1 Базовые настройки выполнены согласно ТЗ: вклчюен пароль на доступ к консоли и на переход в конфигурационный режим
